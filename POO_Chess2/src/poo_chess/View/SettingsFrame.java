...
public class SettingsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Auto save time");
        ...
        jLabel1.setText("Auto save time (s)");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        float autoSaveTime = 15.0f;
        
        try { 
            autoSaveTime = Float.parseFloat(jTextField1.getText());
            if(autoSaveTime < 0) {
                autoSaveTime *= -1;
            }
            jLabel3.setText("Ok value");
        } catch(Exception e) {
            jLabel3.setText("The input must be a number");
        }
                
        ChessSing.updateAutoSaveTime(autoSaveTime);
